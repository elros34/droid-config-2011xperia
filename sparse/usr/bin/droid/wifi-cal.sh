...
WL12xx_MODULE=/lib/modules/3.4.0-LX+/wl12xx_sdio.ko
...
/system/bin/nvimport > /dev/null 2>&1
/system/bin/calibrator set upd_nvs $TARGET_INI_FILE /data/etc/wifi/fw $TARGET_NVS_FILE
/system/bin/calibrator set nvs_mac $TARGET_NVS_FILE $HW_MAC
setprop persist.wlan.ti.calibrated 1
